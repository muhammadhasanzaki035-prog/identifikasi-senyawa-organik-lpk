...
database_reaksi = {
    "Alkohol Primer": {
        "Uji Golongan Alkohol": {
            ...
            "alasan": "Gugus -OH bebas bereaksi menggantikan ligan nitrat pada ion Cerium(IV) membentuk senyawa kompleks koordinasi yang berwarna merah ceri.", 
        ...
        "Uji Oksidasi Alkohol": {
            ...
            "alasan": "Memiliki atom hidrogen alfa. Gugus -OH dioksidasi kuat menjadi asam karboksilat, sedangkan Kromium(VI) jingga tereduksi menjadi Kromium(III) hijau.", 
        ...
        "Uji Golongan Alkohol Sekunder": {
            ...
            "alasan": "Karbokation primer sangat tidak stabil. Reaksi substitusi nukleofilik tidak berjalan membentuk alkil klorida yang tak larut, bahkan setelah dibantu pemanasan.", 
    ...
    "Alkohol Sekunder": {
        ...
        "Uji Oksidasi Alkohol": {
            ...
            "alasan": "Alkohol sekunder dioksidasi menjadi keton. Cr(VI) (jingga) tereduksi ke Cr(III) (hijau).", 
            "warna_akhir": "#10b981", "efek": "none"
        },
        "Uji Golongan Alkohol Sekunder": {
            "hasil": "(+) Emulsi Putih", 
        ...
        "Uji Golongan Metil Keton / Metil Karbinol": {
            ...
            "alasan": "Mengandung struktur metil karbinol yang dioksidasi iodin menjadi metil keton. Gugus metilnya tersubstitusi menjadi kristal iodoform kuning.", 
    ...
    "Alkohol Tersier": {
        ...
        "Uji Golongan Alkohol Tersier": {
            ...
            "alasan": "Membentuk karbokation tersier yang sangat stabil. Reaksi substitusi (SN1) terjadi seketika menghasilkan kabut endapan alkil klorida.", 
    ...
    "Aldehida (Alkanal)": {
        "Uji Golongan Alkohol": {
            ...
            "alasan": "Merupakan senyawa golongan alkanal dan tidak memiliki gugus hidroksil bebas untuk bereaksi dengan Cerium.", 
        ...
        "Uji Spesifik Golongan Alkanal (Schiff)": {
            ...
            "alasan": "Reaksi adisi spesifik yang memulihkan pewarna p-rosanilin hidroklorida menjadi warna ungu murni.", 
    ...
    "Keton (Alkanon)": {
        ...
        "Uji Golongan Alkanal/Aldehida (Bisulfit)": {
            ...
            "alasan": "Keton suku rendah masih memiliki halangan sterik kecil, sehingga bisa mengalami reaksi adisi membentuk garam bisulfit putih.", 
            "warna_akhir": "#ffffff", "efek": "precipitate"
        },
        "Uji Reduksi Golongan Alkanal (Fehling)": {
            "hasil": "(-) Tetap Biru", 
        ...
        "Uji Golongan Metil Keton / Metil Karbinol": {
            ...
            "alasan": "Atom hidrogen alfa pada metil keton sangat asam, tersubstitusi oleh Iodin lalu terputus membentuk kristal Iodoform kuning.", 
            "warna_akhir": "#fef08a", "efek": "precipitate"
        }
    },
    "Ester (Alkil Alkanoat)": {
        "Uji Golongan Alkohol": {
            "hasil": "(-) Kuning", "reaksi": r"$\text{Ester} + \text{Ceric Nitrat} \rightarrow \text{Tidak bereaksi}$", "alasan": "Gugus ester tidak bereaksi dengan uji alkohol.", "warna_akhir": "#facc15", "efek": "none"
        },
        "Uji Golongan Alkanal/Aldehida (Bisulfit)": {
            "hasil": "(-) Bening", "reaksi": r"$\text{Ester} + NaHSO_3 \rightarrow \text{Tidak bereaksi}$", "alasan": "Resonansi pasangan elektron bebas dari gugus etoksi menstabilkan karbon karbonil, menjadikannya tidak reaktif terhadap nukleofil lemah.", "warna_akhir": "#f8fafc", "efek": "none"
        },
        "Uji Golongan Ester": {
            "hasil": "(+) Merah Violet", 
            "reaksi": r"$\text{1. } R-COOR' + NH_2OH \rightarrow R-CONHOH + R'OH \quad \text{2. } 3 R-CONHOH + FeCl_3 \rightarrow Fe(R-CONHO)_3 + 3 HCl$", 
            "alasan": "Ester diubah oleh hidroksilamin menjadi asam hidroksamat yang mengikat ion Fe3+ menghasilkan kompleks berwarna violet.", 
            "warna_akhir": "#c026d3", "efek": "none"
        }
    },
    "Asam Karboksilat": {
        "Uji Golongan Alkohol": {
            "hasil": "(-) Kuning", "reaksi": r"$CH_3COOH + \text{Ceric Nitrat} \rightarrow \text{Tidak bereaksi}$", "alasan": "Oksigen karboksil ditarik oleh resonansi ikatan rangkap karbonil, menjadikannya kurang nukleofilik.", "warna_akhir": "#facc15", "efek": "none"
        },
        "Uji Golongan Alkanal/Aldehida (Bisulfit)": {
            "hasil": "(-) Bening", "reaksi": r"$CH_3COOH + NaHSO_3 \rightarrow \text{Tidak bereaksi}$", "alasan": "Bukan senyawa golongan aldehid atau keton.", "warna_akhir": "#f8fafc", "efek": "none"
        },
        "Uji Golongan Ester": {
            "hasil": "(-) Bening", "reaksi": r"$CH_3COOH + NH_2OH + FeCl_3 \rightarrow \text{Tidak bereaksi}$", "alasan": "Bukan ester. Asam karboksilat tidak memicu pembentukan asam hidroksamat reaktif di kondisi ini.", "warna_akhir": "#f8fafc", "efek": "none"
        },
    ...
    "Alkana / Hidrokarbon Jenuh": {
        "Uji Golongan Alkohol": {
            "hasil": "(-) Kuning", "reaksi": r"$\text{Alkana} + \text{Ceric Nitrat} \rightarrow \text{Tidak bereaksi}$", "alasan": "Tidak ada gugus fungsi -OH.", "warna_akhir": "#facc15", "efek": "none"
        },
        "Uji Golongan Alkanal/Aldehida (Bisulfit)": {
            "hasil": "(-) Bening", "reaksi": r"$\text{Alkana} + NaHSO_3 \rightarrow \text{Tidak bereaksi}$", "alasan": "Tidak ada gugus karbonil.", "warna_akhir": "#f8fafc", "efek": "none"
        },
        "Uji Golongan Ester": {
            "hasil": "(-) Bening", "reaksi": r"$\text{Alkana} + NH_2OH \rightarrow \text{Tidak bereaksi}$", "alasan": "Bukan gugus ester.", "warna_akhir": "#f8fafc", "efek": "none"
        },
        "Uji Golongan Asam Karboksilat": {
            "hasil": "(-) Bening", "reaksi": r"$\text{Alkana} + NaHCO_3 \rightarrow \text{Tidak bereaksi}$", 
            "alasan": "Senyawa hidrokarbon alifatik (jenuh) bersifat non-polar dan inert. Karena berturut-turut gagal bereaksi di seluruh uji fungsional, ini membuktikan senyawanya adalah alkana.", 
            "warna_akhir": "#f8fafc", "efek": "none"
        }
    }
}
...
# --- POST TEST (SISTEM FLOWCHART MULTI-URUTAN) ---
    ...
    if not st.session_state.test_started:
        ...
        # ---------------- LOGIKA ANIMASI & AUTO RUN BERDERET ----------------
        if st.session_state.trigger_animation and st.session_state.current_step < len(urutan):
            ...
            if st.session_state.current_step < len(urutan):
                ...
                status_placeholder.markdown("<div style='text-align:center; color:#475569;'>Menunggu konfirmasi pembacaan data...</div>", unsafe_allow_html=True)
                ...
                status_placeholder.markdown("<div style='text-align:center; font-weight:bold; color:#10b981;'>Seluruh rangkaian uji bagan alir selesai!</div>", unsafe_allow_html=True)
                with log_container:
                    st.info(f"🎉 **KESIMPULAN AKHIR:** Berdasarkan hasil runtunan uji eliminasi spesifik di atas, sampel ini terbukti sah merupakan golongan **{senyawa.upper()}**.")
